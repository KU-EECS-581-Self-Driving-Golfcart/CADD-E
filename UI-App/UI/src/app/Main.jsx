  ...
  return (
    ...
    <div className='flex h-[100vh]'>
      <div className='w-[60%] h-[100vh] flex flex-col items-center justify-center'>
          ...
          <Buttons validNextTee={validNextTee} isGo={isGo} setValidNextTee={setValidNextTee} validGreenTee={validGreenTee} setValidGreenTee={setValidGreenTee} setValidTarget={setValidTarget} name={"Next Teebox"} tee={tee} setNextPosition={setNextPosition}/><br/>
