...
const Welcome = () => {
  return (
    //This Welcome component is the entrypoint to the Application. 
    //The user is promopted to select which tee off location they would like to start from
    //Once selected, the User will be routed to the Main component and state information about their
    //tee off location will be provided to the Main component
